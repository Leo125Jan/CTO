...
if __name__ == '__main__':
	...
	try:
		...
		while (uav_1.agents_state is None) or (uav_1.agents_name is None) or\
				(uav_1.targets_state is None) or (uav_1.targets_name is None) or\
				(uav_1.Cams_state is None) or (uav_1.Cams_name is None) or\
				(uav_1.col_ind is None) or (uav_1.neighbor_index is None) or (uav_1.Pd is None) or\
				(uav_1.cluster_set is None) or (uav_1.teammate is None):
		...
		while not rospy.is_shutdown():
			...
			neighbor_index, teammate, varb_list_copy = uav_1.Neighbor_Connection()
			uav_1.Collect_Data(neighbor_index, teammate, varb_list_copy)
