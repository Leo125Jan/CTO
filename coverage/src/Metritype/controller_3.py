...
if __name__ == '__main__':
	...
	try:
		...
		while (uav_3.agents_state is None) or (uav_3.agents_name is None) or\
				(uav_3.targets_state is None) or (uav_3.targets_name is None) or\
				(uav_3.Cams_state is None) or (uav_3.Cams_name is None) or\
				(uav_3.col_ind is None) or (uav_3.neighbor_index is None) or (uav_3.Pd is None) or\
				(uav_3.cluster_set is None) or (uav_3.teammate is None):
		...
		while not rospy.is_shutdown():
			...
			neighbor_index, teammate, varb_list_copy = uav_3.Neighbor_Connection()
			uav_3.Collect_Data(neighbor_index, teammate, varb_list_copy)
