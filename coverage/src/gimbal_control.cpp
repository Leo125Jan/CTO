...
int main(int argc, char **argv)
{
    ...
    ros::param::get("self_name", self_name);
    ros::param::get("target_name", target_name);

    GimbalControl gb(self_name, target_name);
...
#if TRACK_REVISED
    std::cout << "start tracking ......" << std::endl;
    gb.TrackingControllerR(gb.ALWAYSON, gb.typhoon, gb.measure_off);   //gb.SEARCH, gb.ALWAYSON, gb.HOLD
#endif
