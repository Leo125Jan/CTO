...
if __name__ == '__main__':
	...
	try:
		...
		while (uav_4.agents_state is None) or (uav_4.agents_name is None) or\
				(uav_4.targets_state is None) or (uav_4.targets_name is None) or\
				(uav_4.Cams_state is None) or (uav_4.Cams_name is None) or\
				(uav_4.col_ind is None) or (uav_4.neighbor_index is None) or (uav_4.Pd is None) or\
				(uav_4.cluster_set is None) or (uav_4.teammate is None):
		...
		while not rospy.is_shutdown():
			...
			neighbor_index, teammate, varb_list_copy = uav_4.Neighbor_Connection()
			uav_4.Collect_Data(neighbor_index, teammate, varb_list_copy)
