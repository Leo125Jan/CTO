...
def	controller(time_):
	...
	u_des = np.array([1*((currP7[0] - P7[0])), 1*((currP7[1] - P7[1])), 9.8 - P7[2]])
...
def Path_Follower(t):
	...
	if t < 20:
		...
		u_des = 2.0*np.array([(P9[0]-P7[0])-1.3+P9v[0] + (P8[0]-P7[0]), (P9[1]-P7[1])-1.0+P9v[1] + (P8[1]-P7[1])-2, 2*(9.8 - P7[2])])
		u_mag = 0.5
	else:

		if P7[0] <= 17.0 and P7[1] <= 6.0:

			u_des = np.array([10*(0.1), 2*(5.5-P7[1]), 2*(9.8 - P7[2])])

		if P7[0] > 17.0 and P7[1] <= 17.0:

			u_des = np.array([2*(17.5-P7[0]), 10*(0.1), 9.8 - P7[2]])

		if P7[0] > 6.0 and P7[1] > 17.0:

			u_des = np.array([-10*(0.1), 2*(17.5-P7[1]), 9.8 - P7[2]])

		if P7[0] <= 7.5 and P7[1] > 6.0:

			u_des = np.array([2*(7.0-P7[0]), -10*(0.1), 9.8 - P7[2]])

		u_mag = 0.4

	# CBF
	# neighbors_pos = np.array([P5, P6, P8, P9])
	# neighbors_vel = np.array([P5v, P6v, P8v, P9v])
	# dt_min = 0.35
