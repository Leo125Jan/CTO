...
def Read_Data_Target_Speed():
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/O/0.10/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/O/0.25/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/O/0.50/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/O/0.75/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/O/0.90/"
			files = Path(filename).glob("*.csv")
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/O/0.10/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/O/0.25/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/O/0.50/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/O/0.75/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/O/0.90/"
			files = Path(filename).glob("*.csv")
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/0.10/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/0.25/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/0.50/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/0.75/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/0.90/"
			files = Path(filename).glob("*.csv")
	...
	ax1.legend(loc = 'lower right', ncol = 1, shadow = True, fontsize = 12)
...
def Read_Data_Sensing_Range():
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/3/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/4/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/5/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/6/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/7/"
			files = Path(filename).glob("*.csv")
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/3/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/4/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/5/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/6/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/7/"
			files = Path(filename).glob("*.csv")
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/3/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/4/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/5/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/6/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/7/"
			files = Path(filename).glob("*.csv")
	...
	# my_path = "/home/leo/圖片/Research_Picture/8.1/"
	# my_file = 'ANOT_Sensing_Range.png'
	# fig.savefig(os.path.join(my_path, my_file))
