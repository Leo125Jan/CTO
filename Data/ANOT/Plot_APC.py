...
def Read_Data_Target_Speed():
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/APC/0.10/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/APC/0.25/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/APC/0.50/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/APC/0.75/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/APC/0.90/"
			files = Path(filename).glob("*.csv")
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/APC/0.10/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/APC/0.25/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/APC/0.50/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/APC/0.75/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/APC/0.90/"
			files = Path(filename).glob("*.csv")
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/APC/0.10/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/APC/0.25/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/APC/0.50/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/APC/0.75/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/APC/0.90/"
			files = Path(filename).glob("*.csv")
	...
	ax0.set_xlabel("Target speed (Sensing range set at 4) (unit/s)", fontdict = {'fontsize': 20})
...
def Read_Data_Sensing_Range():
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/APC/3/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/APC/4/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/APC/5/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/APC/6/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/APC/7/"
			files = Path(filename).glob("*.csv")
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/APC/3/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/APC/4/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/APC/5/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/APC/6/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/APC/7/"
			files = Path(filename).glob("*.csv")
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/APC/3/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/APC/4/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/APC/5/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/APC/6/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/APC/7/"
			files = Path(filename).glob("*.csv")
	...
	ax0.plot(x, y2, color = Color_Key[2], label = Name_Key[2], marker = Marker_Key[2])
	ax0.set_title("Comparison of normalized average number of observed target", fontdict = {'fontsize': 20})
	ax0.set_xlabel("Sensing range (Target speed set at 0.5)", fontdict = {'fontsize': 20})
	ax0.set_ylabel("ANOT", fontdict = {'fontsize': 20})
	# ax0.set_xticks(x, x_)
	ax0.tick_params(axis='both', which='major', labelsize = 20)
	ax0.legend(loc = 'lower right', ncol = 1, shadow = True, fontsize = 12)

	plt.setp(ax0, xticks=[3, 4, 5, 6, 7], xticklabels=["3", "4", "5", "6", "7"]
					, yticks=[0.25, 0.5, 0.75, 1.0], yticklabels=["0.25", "0.5", "0.75", "1.0"])
	plt.tight_layout()
	plt.show()
...
if __name__ == "__main__":
	...
	# Execute_read()
	# PlotData()
	Read_Data_Target_Speed()
	Read_Data_Sensing_Range()