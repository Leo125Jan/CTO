...
def Read_Data_Target_Speed():
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/T/0.10/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/T/0.25/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/T/0.50/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/T/0.75/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Target_Speed/T/0.90/"
			files = Path(filename).glob("*.csv")
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/T/0.10/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/T/0.25/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/T/0.50/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/T/0.75/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Target_Speed/T/0.90/"
			files = Path(filename).glob("*.csv")
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/T/0.10/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/T/0.25/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/T/0.50/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/T/0.75/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Target_Speed/T/0.90/"
			files = Path(filename).glob("*.csv")
	...
	my_path = "/home/leo/圖片/Research_Picture/8.14/"
...
def Read_Data_Sensing_Range():
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/T/3/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/T/4/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/T/5/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/T/6/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/FCM/Sensing_Range/T/7/"
			files = Path(filename).glob("*.csv")
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/T/3/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/T/4/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/T/5/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/T/6/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/K/Sensing_Range/T/7/"
			files = Path(filename).glob("*.csv")
	...
	for i in range(5):
		...
		if i == 0:
			...
			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/T/3/"
			files = Path(filename).glob("*.csv")
		elif i == 1:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/T/4/"
			files = Path(filename).glob("*.csv")
		elif i == 2:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/T/5/"
			files = Path(filename).glob("*.csv")
		elif i == 3:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/T/6/"
			files = Path(filename).glob("*.csv")
		elif i == 4:

			filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/Sensing_Range/T/7/"
			files = Path(filename).glob("*.csv")
