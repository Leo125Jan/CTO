...
def Hungarian(targets, cameras):
	...
	if targets_len > agents_len or targets_len == agents_len:
		...
		for i in range(len(gain)):
			...
			# print("gain: ", 1/np.array(gain))

			# cost_matrix[:,i] = 0.6*cost_matrix[:,i] + 0.4*10*(1/np.array(gain[i]))
			cost_matrix[:,i] = cost_matrix[:,i]*(1/np.array(gain[i]))
	...
	for i in range(1):
		...
		for i in range(len(cameras)):
			...
			if cp == "FCM":
				...
				# filename = "C:/Users/leomd/IME/Master Thesis/CTO-main/Data/ANOT/FCM/" + save_type[save_key] + "One/" + speed_gain + "/"
				# filename = "C:/Users/leomd/IME/Master Thesis/CTO-main/Data/ANOT/FCM/" + save_type[save_key] + "One/" + sensing_range + "/"
				filename = "C:/Users/leomd/IME/Master Thesis/CTO-main/Data/ANOT/FCM/Table/" + Times
				filename += "FCM_" + str(i) + "_" + save_type[save_key] + ".csv"
			elif cp == "K":

				# filename = "C:/Users/leomd/IME/Master Thesis/CTO-main/Data/ANOT/K/" + save_type[save_key] + "One/" + speed_gain + "/"
				# filename = "C:/Users/leomd/IME/Master Thesis/CTO-main/Data/ANOT/K/" + save_type[save_key] + "One/" + sensing_range + "/"
				filename = "C:/Users/leomd/IME/Master Thesis/CTO-main/Data/ANOT/K/Table/" + Times
				filename += "K_" + str(i) + "_" + save_type[save_key] + ".csv"
			elif cp == "PA":

				# filename = "C:/Users/leomd/IME/Master Thesis/CTO-main/Data/ANOT/PA/" + save_type[save_key] + "One/" + speed_gain + "/"
				# filename = "/home/leo/mts/src/QBSM/Data/ANOT/PA/" + save_type[save_key] + sensing_range + "/"
				filename = "C:/Users/leomd/IME/Master Thesis/CTO-main/Data/ANOT/PA/Table/" + Times
		...
		while not Done:
			...
			if run_step >= 100:
				...
				if run_step%100 == 0:
					...
					velocities = (float(speed_gain)/0.5)*(np.random.rand(len(targets), 2) - 0.5)*0
			...
			for i in range(len(uav_team.members)):
				...
				uav_team.members[i].UpdateState(targets, neighbors, one_hop_neighbor, Pd, cluster_set, col_ind, cluster_labels, 
										cluster_centers, np.round(time() - last, 2), cp, speed_gain, save_type[save_key], Times)
